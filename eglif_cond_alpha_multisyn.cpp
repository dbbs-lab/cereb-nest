...
template <> void RecordablesMap<nest::eglif_cond_alpha_multisyn>::create() {
  // use standard names whereever you can for consistency!
  /* generated by template org.nest.nestml.function.RecordCallback*/


  insert_("I_dep", &nest::eglif_cond_alpha_multisyn::get_I_dep);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("I_adap", &nest::eglif_cond_alpha_multisyn::get_I_adap);


  insert_("V_th", &nest::eglif_cond_alpha_multisyn::get_V_th);


  //insert_("y_0", &nest::eglif_cond_alpha_multisyn::get_y_0);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("V_m", &nest::eglif_cond_alpha_multisyn::get_V_m);


  insert_("I_gen", &nest::eglif_cond_alpha_multisyn::get_I_gen);


  insert_("sum_buffer", &nest::eglif_cond_alpha_multisyn::get_sum_buffer);


  insert_("G1", &nest::eglif_cond_alpha_multisyn::get_G1);


  insert_("DG1", &nest::eglif_cond_alpha_multisyn::get_DG1);


  insert_("G2", &nest::eglif_cond_alpha_multisyn::get_G2);


  insert_("DG2", &nest::eglif_cond_alpha_multisyn::get_DG2);


  insert_("G3", &nest::eglif_cond_alpha_multisyn::get_G3);


  insert_("DG3", &nest::eglif_cond_alpha_multisyn::get_DG3);
  ...
  //insert_("time", &nest::eglif_cond_alpha_multisyn::get_time);
...
nest::eglif_cond_alpha_multisyn::Parameters_::Parameters_() {}

nest::eglif_cond_alpha_multisyn::State_::State_() {}

/* ----------------------------------------------------------------
* Parameter and state extractions and manipulation functions
* ---------------------------------------------------------------- */

void nest::eglif_cond_alpha_multisyn::Parameters_::set(
    const DictionaryDatum &__d) {}

void nest::eglif_cond_alpha_multisyn::State_::set(const DictionaryDatum &__d,
                                                   const Parameters_ &p) {}

nest::eglif_cond_alpha_multisyn::Buffers_::Buffers_(
...
nest::eglif_cond_alpha_multisyn::eglif_cond_alpha_multisyn()
...
void nest::eglif_cond_alpha_multisyn::init_state_(
...
eglif_cond_alpha_multisyn_dynamics(double, const double y[], double f[],
  ...
  //const double tIe = kernel().simulation_manager.get_time().get_ms();

  typedef nest::eglif_cond_alpha_multisyn::State_ State_;
  // get access to node so we can almost work as in a member function
  assert(pnode);
  const nest::eglif_cond_alpha_multisyn &node =
      *(reinterpret_cast<nest::eglif_cond_alpha_multisyn *>(pnode));
...
void nest::eglif_cond_alpha_multisyn::init_buffers_() {
...
void nest::eglif_cond_alpha_multisyn::calibrate() {
  B_.logger_.init();
  ...
  V_.RefractoryCounts =
      Time(Time::ms((double)P_.t_ref)).get_steps();
 ...
 */
void nest::eglif_cond_alpha_multisyn::update(Time const &origin,
                                              const long from, const long to) {

  double step_ = Time::get_resolution().get_ms();
  double IntegrationStep_ = Time::get_resolution().get_ms();
  double t = 0;
   ...
   if (lag == from){
    ...
    if (V_.r == 0) {
      ...
      while (t < step_) {
        ...
        std::cout << " some visible text\r" << std::endl;
...
void nest::eglif_cond_alpha_multisyn::handle(DataLoggingRequest &e) {
  B_.logger_.handle(e);
}

void nest::eglif_cond_alpha_multisyn::handle(SpikeEvent &e) {
...
void nest::eglif_cond_alpha_multisyn::handle(CurrentEvent &e) {
  assert(e.get_delay_steps() > 0);
