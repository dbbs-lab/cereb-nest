...
public:
 ...
 /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/
  ...
  inline double get_Vth() const { return P_.Vth; }

  inline void set_Vth(const double v) { P_.Vth = v; }
...
protected:
 ...
 /* generated by template org.nest.nestml.function.StructGetterSetter*/
    ...
    inline double get_Vth() const { return Vth; }
    inline void set_Vth(const double Vth) { this->Vth = Vth; }
...
/* generated by template org.nest.nestml.function.ReadFromDictionary*/
  ...
  double tmp_Vth;
  if (updateValue<double>(__d, "Vth", tmp_Vth)) {
    set_Vth(tmp_Vth);
  }
