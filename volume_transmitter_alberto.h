...
public:
   ...
   **/
  void set_local_device_id( const nest::synindex ldid );
...
private:
  ...
  nest::synindex local_device_id_;
};

inline size_t
volume_transmitter_alberto::handles_test_event( nest::SpikeEvent&, size_t receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline void
volume_transmitter_alberto::set_local_device_id( const nest::synindex ldid )
{
