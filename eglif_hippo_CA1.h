...
#ifndef EGLIF_HIPPO_CA1
#define EGLIF_HIPPO_CA1
#include "config.h"
...
/*
extern "C" inline int
eglif_hippo_CA1_dynamics(double, const double*, double*,
                                          void *pnode);*/
...
/* BeginDocumentation
Name: eglif_hippo_CA1 .

//
Name: eglif_hippo_CA1_nestml - Extended Generalized Leaky
integrate-and-fire neuron model with multiple ports based. Described in [Geminiani et al., Front Neuroinf, 2018].

Description (NESTML):

eglif_hippo_CA1_nestml from iaf_psc_exp_multisynapse_nestml.
...
Empty
*/
class eglif_hippo_CA1 : public nest::Archiving_Node {
public:
  /**
  ...
  */
  eglif_hippo_CA1(const eglif_hippo_CA1 &);
 ...
 /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/
  ...
  inline void set_a(const double v) { P_.a = v; }  // Parameters for exp cum update of Iadap
  ...
  inline double get_ts() const { return P_.ts; }

  inline void set_ts(const double v) { P_.ts = v; }

  inline double get_mul() const { return P_.mul; }

  inline void set_mul(const double v) { P_.mul = v; }

  inline double get_ith() const { return P_.ith; }

  inline void set_ith(const double v) { P_.ith = v; }

  inline double get_sc() const { return P_.sc; }

  inline void set_sc(const double v) { P_.sc = v; }

  inline double get_bet() const { return P_.bet; }

  inline void set_bet(const double v) { P_.bet = v; }

  inline double get_delta1() const { return P_.delta1; }

  inline void set_delta1(const double v) { P_.delta1 = v; }

  inline double get_Idep_ini_vr() const { return P_.Idep_ini_vr; }
  ...
  inline double get_alp() const { return P_.alp; }

  inline void set_alp(const double v) { P_.alp = v; }

  inline double get_istim_min_spiking_exp() const { return P_.istim_min_spiking_exp; }

  inline void set_istim_min_spiking_exp(const double v) { P_.istim_min_spiking_exp = v; }

  inline double get_istim_max_spiking_exp() const { return P_.istim_max_spiking_exp; }

  inline void set_istim_max_spiking_exp(const double v) { P_.istim_max_spiking_exp = v; }

  inline double get_soglia_sign() const { return P_.soglia_sign; }

  inline void set_soglia_sign(const double v) { P_.soglia_sign = v; }
  ...
  inline std::vector<double> get_bufferVm() const { return V_.bufferVm; }

  inline void set_bufferVm(const std::vector<double> v) { V_.bufferVm = v; }
  ...
  inline double get_I_input() const { return V_.I_input; }

  inline void set_I_input(const double v) { V_.I_input = v; }

  inline double get_sum_buffer() const { return V_.sum_buffer; }

  inline void set_sum_buffer(const double v) { V_.sum_buffer = v; }

  inline double get_init_sign() const { return V_.init_sign; }

  inline void set_init_sign(const double v) { V_.init_sign = v; }
...
protected:
  ...
  friend class nest::RecordablesMap<eglif_hippo_CA1>;
  friend class nest::UniversalDataLogger<eglif_hippo_CA1>;
  ...
  */
  struct Parameters_ {
   ...
   double tau_syn3; //
    ...
    double ts;          // time threshold for depolarization block
    ...
    double istim_min_spiking_exp;

    double istim_max_spiking_exp;
 ...
 /* generated by template org.nest.nestml.function.StructGetterSetter*/
    ...
    inline void set_ts(const double ts) { this->ts = ts; }

    inline double get_mul() const { return mul; }
    inline void set_mul(const double mul) { this->mul = mul; }

    inline double get_ith() const { return ith; }
    inline void set_ith(const double ith) { this->ith = ith; }

    inline double get_sc() const { return sc; }
    inline void set_sc(const double sc) { this->sc = sc; }

    inline double get_bet() const { return bet; }
    inline void set_bet(const double bet) { this->bet = bet; }

    inline double get_delta1() const { return delta1; }
    inline void set_delta1(const double delta1) { this->delta1 = delta1; }
    ...
    inline double get_alp() const { return alp; }
    inline void set_alp(const double alp) { this->alp = alp; }

    inline double get_istim_min_spiking_exp() const { return istim_min_spiking_exp; }
    inline void set_istim_min_spiking_exp(const double istim_min_spiking_exp) { this->istim_min_spiking_exp = istim_min_spiking_exp; }

    inline double get_istim_max_spiking_exp() const { return istim_max_spiking_exp; }
    inline void set_istim_max_spiking_exp(const double istim_max_spiking_exp) { this->istim_max_spiking_exp = istim_max_spiking_exp; }

    inline double get_soglia_sign() const { return soglia_sign; }
    inline void set_soglia_sign(const double soglia_sign) { this->soglia_sign = soglia_sign; }
  ...
  */
  struct Variables_ {
    ...
    inline std::vector<double> get_bufferVm() const { return bufferVm; }
    inline void set_bufferVm(const std::vector<double> bufferVm) {
      this->bufferVm = bufferVm;
    }
    ...
    inline double get_I_input() const { return I_input; }
    inline void set_I_input(const double I_input) { this->I_input = I_input; }
    ...
    inline double get_init_sign() const { return init_sign; }
    inline void set_init_sign(const double init_sign) { this->init_sign = init_sign; }
   ...
   * that
    ...
    */
  struct Buffers_ {
    Buffers_(eglif_hippo_CA1 &);
    Buffers_(const Buffers_ &, eglif_hippo_CA1 &);
    ...
    nest::UniversalDataLogger<eglif_hippo_CA1> logger_;
...
private:
  ...
  */
  ...
  static nest::RecordablesMap<eglif_hippo_CA1> recordablesMap_;

  friend int eglif_hippo_CA1_dynamics(double, const double y[],
                                                       double f[], void *pnode);
 // friend int eglif_hippo_CA1_dynamics(double, const double*,
  //                                                     double*, void *pnode);

  /** @} */
}; /* neuron eglif_hippo_CA1 */

inline nest::port eglif_hippo_CA1::send_test_event(
...
inline nest::port
eglif_hippo_CA1::handles_test_event(nest::SpikeEvent &,
...
inline nest::port
eglif_hippo_CA1::handles_test_event(nest::CurrentEvent &,
                                                     nest::port receptor_type) {
  // You should usually not change the code in this function.
...
inline nest::port eglif_hippo_CA1::handles_test_event(
...
inline void
eglif_hippo_CA1::get_status(DictionaryDatum &__d) const {
...
/* generated by template org.nest.nestml.function.WriteInDictionary*/
  ...
  def<double>(__d, "ts", get_ts());

  def<double>(__d, "mul", get_mul());

  def<double>(__d, "ith", get_ith());

  def<double>(__d, "sc", get_sc());

  def<double>(__d, "bet", get_bet());

  def<double>(__d, "delta1", get_delta1());
  ...
  def<double>(__d, "istim_min_spiking_exp", get_istim_min_spiking_exp());

  def<double>(__d, "istim_max_spiking_exp", get_istim_max_spiking_exp());

  def<double>(__d, "soglia_sign", get_soglia_sign());
...
inline void
eglif_hippo_CA1::set_status(const DictionaryDatum &__d) {
...
/* generated by template org.nest.nestml.function.ReadFromDictionary*/
  ...
  double tmp_ts;
  if (updateValue<double>(__d, "ts", tmp_ts)) {
    set_ts(tmp_ts);
  }

  double tmp_mul;
  if (updateValue<double>(__d, "mul", tmp_mul)) {
    set_mul(tmp_mul);
  }

  double tmp_ith;
  if (updateValue<double>(__d, "ith", tmp_ith)) {
    set_ith(tmp_ith);
  }

  double tmp_sc;
  if (updateValue<double>(__d, "sc", tmp_sc)) {
    set_sc(tmp_sc);
  }

  double tmp_bet;
  if (updateValue<double>(__d, "bet", tmp_bet)) {
    set_bet(tmp_bet);
  }

  double tmp_delta1;
  if (updateValue<double>(__d, "delta1", tmp_delta1)) {
    set_delta1(tmp_delta1);
  }
  ...
  double tmp_psi1;
  if (updateValue<double>(__d, "psi1", tmp_psi1)) {
    set_psi1(tmp_psi1);
  }

  double tmp_alp;
  if (updateValue<double>(__d, "alp", tmp_alp)) {
    set_alp(tmp_alp);
  }

  double tmp_istim_min_spiking_exp;
  if (updateValue<double>(__d, "istim_min_spiking_exp", tmp_istim_min_spiking_exp)) {
    set_istim_min_spiking_exp(tmp_istim_min_spiking_exp);
  }

  double tmp_istim_max_spiking_exp;
  if (updateValue<double>(__d, "istim_max_spiking_exp", tmp_istim_max_spiking_exp)) {
    set_istim_max_spiking_exp(tmp_istim_max_spiking_exp);
  }

  double tmp_soglia_sign;
  if (updateValue<double>(__d, "soglia_sign", tmp_soglia_sign)) {
    set_soglia_sign(tmp_soglia_sign);
  }
