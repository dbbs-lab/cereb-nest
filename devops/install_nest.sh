...
cmake -Dwith-python=3 -DPYTHON_EXECUTABLE=/home/travis/ -DPYTHON_LIBRARY=/usr/lib/x86_64-linux-gnu/libpython3.6m.so -DPYTHON_INCLUDE_DIR=/usr/include/python3.6m/ -DCMAKE_INSTALL_PREFIX:PATH=/home/travis/nest-$NEST_VERSION /home/travis/nest-simulator-$NEST_VERSION
make
make install
cd $MY_BEFORE_DIR
